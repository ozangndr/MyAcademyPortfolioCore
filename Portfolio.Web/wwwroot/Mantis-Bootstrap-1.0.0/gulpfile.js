...
gulp.task("sass", function () {
  // main style css
  return gulp
    .src("s~/Mantis-Bootstrap-1.0.0/dist/assets/scss/*.scss")
    .pipe(sourcemaps.init())
    .pipe(sass())
    .pipe(autoprefixer())
    .pipe(sourcemaps.write())
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/css"));
});
//  [ scss compiler ] end
...
gulp.task("build", function () {
  var required_libs = {
    js: [
      ...
      "node_modules/choices.js/publ~/Mantis-Bootstrap-1.0.0/dist/assets/scripts/choices.min.js",
  ...
  npmlodash(required_libs).forEach(function (assets, type) {
    if (type == "css") {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/css/plugins"));
    } else {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins"));
    }
  });
  var required_libs = {
    classic: [
  ...
  npmlodash(required_libs).forEach(function (assets, type) {
    if (type == "classic") {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/ckeditor/classic"));
    }
    if (type == "inline") {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/ckeditor/inline"));
    }
    if (type == "balloon") {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/ckeditor/balloon"));
    }
    if (type == "document") {
      gulp.src(assets).pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/ckeditor/document"));
    }
  });
  var cpyassets = gulp
    .src(["s~/Mantis-Bootstrap-1.0.0/dist/assets/**/*.*", "!s~/Mantis-Bootstrap-1.0.0/dist/assets/scss/**/*.*"])
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets"));
  var cpytinymceassets = gulp
    .src(["node_modules/tinymce/**/*.*"])
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/tinymce"));

  var cpytrumbowygassets = gulp
    .src(["node_modules/trumbowyg/dist/**/*.*"])
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/plugins/trumbowyg"));
...
gulp.task("build-js", function () {
  var layoutjs = gulp
    .src("s~/Mantis-Bootstrap-1.0.0/dist/assets/js/*.js")
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js"));

  var pagesjs = gulp
    .src("s~/Mantis-Bootstrap-1.0.0/dist/assets/js/pages/*.js")
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/js/pages"));
...
gulp.task("imgmin", function () {
  return gulp
    .src("s~/Mantis-Bootstrap-1.0.0/dist/assets/img/**/*.{jpg,png}")
    .pipe(smushit())
    .pipe(gulp.dest("di~/Mantis-Bootstrap-1.0.0/dist/assets/img"));
});
//  [ image optimizer ] end
...
gulp.task("watch", function () {
  gulp
    .watch("s~/Mantis-Bootstrap-1.0.0/dist/assets/scss/**/*.scss", gulp.series("sass"))
    .on("change", browsersync.reload);
  gulp
    .watch("s~/Mantis-Bootstrap-1.0.0/dist/assets/js/**/*.js", gulp.series("build-js"))
    .on("change", browsersync.reload);
  gulp
...
gulp.task("watch-minify", function () {
  gulp.watch("s~/Mantis-Bootstrap-1.0.0/dist/assets/scss/**/*.scss", gulp.series("mincss"));
  gulp.watch("s~/Mantis-Bootstrap-1.0.0/dist/assets/js/**/*.js", gulp.series("uglify"));
