...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('#btn-default-i').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/clock-48.png', 0);
  });

  document.querySelector('#btn-info-i').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/survey-48.png', 0);
  });

  document.querySelector('#btn-success-i').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/ok-48.png', 0);
  });
  ...
  document.querySelector('#btn-warning-i').addEventListener('click', function () {
    notifier.show(
      ...
      'warning',
      '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/medium_priority-48.png',
      0
    );
  });

  document.querySelector('#btn-danger-i').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/high_priority-48.png', 0);
  });

  document.querySelector('#btn-default-ac').addEventListener('click', function () {
    notifier.show('Default!', 'I am a default notification.', '', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/clock-48.png', 4000);
  });

  document.querySelector('#btn-info-ac').addEventListener('click', function () {
    notifier.show('Reminder!', 'You have a meeting at 10:30 AM.', 'info', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/survey-48.png', 4000);
  });

  document.querySelector('#btn-success-ac').addEventListener('click', function () {
    notifier.show('Well Done!', 'You just submit your resume successfully.', 'success', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/ok-48.png', 4000);
  });
  ...
  document.querySelector('#btn-danger-ac').addEventListener('click', function () {
    notifier.show('Sorry!', 'Could not complete your transaction.', 'danger', '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/high_priority-48.png', 4000);
  });
  ...
  var showNotification = function () {
    notificationId = notifier.show(
      ...
      'info',
      '~/Mantis-Bootstrap-1.0.0/dist/assets/images/notification/survey-48.png',
      4000
    );
  };
